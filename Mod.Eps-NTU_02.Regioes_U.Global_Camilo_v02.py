...
Cond.T = np.zeros((linD, n_var))  # Inicializando a matriz das temperaturas dentro do condensador
Cond.P = np.zeros((linD, n_var))  # Inicializando a matriz das Pressões dentro do condensador
...
"""Obtendo as vazões de vapor e água"""
